...
var hookWrapper = utils.createHookWrapper('embedding');
...
exports.setup = function(collection, relations) {
	collection.on('beforeInsertOne', hookWrapper(function(params, callback) {
		processEmbeddedDocuments(params.obj, relations, callback);
	}));

	collection.on('beforeInsertMany', hookWrapper(function(params, callback) {
