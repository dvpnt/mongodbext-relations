...
var setupRelationHooks = function(relatedCollection, relation) {
	...
	var beforeUpdate = utils.hookWrapper(function(params, callback) {
	...
	var afterUpdate = utils.hookWrapper(function(params, callback) {
	...
	var afterUpsert = utils.hookWrapper(function(params, callback) {
	...
	var beforeDelete = utils.hookWrapper(function(params, callback) {
		if (
	...
	var afterDelete = utils.hookWrapper(function(params, callback) {
